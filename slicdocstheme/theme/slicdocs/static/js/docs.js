...
/* BB 150310
   slicdocstheme provides three types of admonitions, important, note
...
/* BB 150310
   ...
   work on the three slicdocstheme admonitions.
...
// Launchpad with pre-filled information such as git SHA, git.slic.org
...
function logABug(bugTitle, bugProject, fieldComment, fieldTags) {
    ...
    var bugChecklist = "This bug tracker is for errors with the documentation, " +
        ...
        " - Ask Slic: http://ask.slic.org" + lineFeed +
        " - The mailing list: http://lists.slic.org" + lineFeed +
        " - IRC: 'slic' channel on Freenode"+ lineFeed;

    var urlBase = "https://bugs.launchpad.net/" + bugProject + "/+filebug?field.title=";
    var currentURL = "URL: " + window.location.href;
    var bugLink = "";
    if (useStoryboard) {
        var urlBase = "https://storyboard.slic.org/#!/project/";
